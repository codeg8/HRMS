...
(function($) {
    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            selector_div.className = is_stacked ? 'm-selector stacked' : 'm-selector';
            ...
            var filter_input = quickElement('input', filter_p, '', 'type', 'text', 'placeholder', gettext("Filter"), 'class', 'form-control');
